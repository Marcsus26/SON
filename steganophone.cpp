...
struct mydspSIG0 {
	...
	void fillmydspSIG0(int count, float* table) {
		for (int i1 = 0; i1 < count; i1 = i1 + 1) {
			iVec0[0] = 1;
			iRec0[0] = (iVec0[1] + iRec0[1]) % 1024;
			table[i1] = std::sin(0.0061359233f * static_cast<float>(iRec0[0]));
			iVec0[1] = iVec0[0];
			iRec0[1] = iRec0[0];
		}
	}
...
struct mydsp : public dsp {
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			fRec2[0] = static_cast<float>(input1[i0]) - fConst7 * (fConst5 * fRec2[2] + fConst3 * fRec2[1]);
			float fTemp1 = static_cast<float>(input0[i0]);
			float fTemp2 = std::fabs(fTemp1);
			fVec2[0] = fTemp2;
			fRec3[0] = -(fConst10 * (fConst9 * fRec3[1] - (fTemp2 + fVec2[1])));
			output0[i0] = static_cast<FAUSTFLOAT>(fTemp1 + fConst11 * fRec3[0] * (fRec2[2] + fRec2[0] + 2.0f * fRec2[1]) * ftbl0mydspSIG0[std::max<int>(0, std::min<int>(static_cast<int>(1024.0f * fRec1[0]), 1023))]);
			iVec1[1] = iVec1[0];
			fRec1[1] = fRec1[0];
			fRec2[2] = fRec2[1];
			fRec2[1] = fRec2[0];
