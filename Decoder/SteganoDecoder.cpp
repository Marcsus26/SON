...
struct mydsp : public dsp {
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst3 = fConst0 * std::sin(12566.371f / fConst0);
		fConst4 = 3141.5928f / fConst3;
		...
		fConst16 = std::tan(9424.778f / fConst0);
		fConst17 = 2.0f * (1.0f - 1.0f / mydsp_faustpower2_f(fConst16));
		fConst18 = 1.0f / fConst16;
		fConst19 = (fConst18 + -0.76536685f) / fConst16 + 1.0f;
		fConst20 = 1.0f / ((fConst18 + 0.76536685f) / fConst16 + 1.0f);
		fConst21 = (fConst18 + -1.847759f) / fConst16 + 1.0f;
		fConst22 = 1.0f / ((fConst18 + 1.847759f) / fConst16 + 1.0f);
		fConst23 = 1.7e+04f / fConst0;
		fConst24 = std::tan(56548.668f / fConst0);
		fConst25 = std::sqrt(4.0f * mydsp_faustpower2_f(fConst0) * std::tan(50265.484f / fConst0) * fConst24);
		fConst26 = mydsp_faustpower2_f(fConst25);
		fConst27 = 1.0f / fConst0;
		fConst28 = mydsp_faustpower3_f(fConst27) * fConst26;
		fConst29 = fConst0 * fConst24;
		fConst30 = 2.0f * fConst29 - 0.5f * (fConst26 / fConst29);
		fConst31 = fConst30 * (6.122935f / fConst0 + 1.5307337f * fConst28);
		fConst32 = mydsp_faustpower2_f(fConst30);
		fConst33 = mydsp_faustpower2_f(fConst27);
		fConst34 = mydsp_faustpower4_f(fConst27) * mydsp_faustpower4_f(fConst25);
		fConst35 = fConst34 + fConst33 * (4.0f * fConst32 + 8.0f * fConst26);
		fConst36 = fConst35 + (16.0f - fConst31);
		fConst37 = 3.0614674f * fConst28;
		fConst38 = 12.24587f / fConst0;
		fConst39 = 4.0f * fConst34;
		fConst40 = fConst39 + fConst30 * (fConst38 - fConst37) + -64.0f;
		fConst41 = 6.0f * fConst34 + (96.0f - fConst33 * (8.0f * fConst32 + 16.0f * fConst26));
		fConst42 = fConst39 + fConst30 * (fConst37 - fConst38) + -64.0f;
		fConst43 = fConst35 + fConst31 + 16.0f;
		fConst44 = 1.0f / fConst43;
		fConst45 = fConst30 * (14.782072f / fConst0 + 3.695518f * fConst28);
		fConst46 = fConst35 + (16.0f - fConst45);
		fConst47 = 7.391036f * fConst28;
		fConst48 = 29.564144f / fConst0;
		fConst49 = fConst39 + fConst30 * (fConst48 - fConst47) + -64.0f;
		fConst50 = fConst39 + fConst30 * (fConst47 - fConst48) + -64.0f;
		fConst51 = fConst45 + fConst35 + 16.0f;
		fConst52 = 1.0f / fConst51;
		fConst53 = fConst33 * fConst32;
		fConst54 = fConst53 / fConst51;
		fConst55 = fConst53 / fConst43;
		fConst56 = 1.0f / (fConst10 * fConst14);
		fConst57 = 6268.3013f / fConst3;
		fConst58 = (fConst5 - fConst57) / fConst1 + 1.0f;
		fConst59 = (fConst5 + fConst57) / fConst1 + 1.0f;
		fConst60 = 8e+01f / fConst7;
		fConst61 = 0.33333334f / fConst7;
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			iVec0[0] = 1;
			float fTemp0 = fConst2 * fRec0[1];
			float fTemp1 = ((1 - iVec0[1]) ? 0.0f : fConst23 + fRec5[1]);
			fRec5[0] = fTemp1 - std::floor(fTemp1);
			fRec7[0] = static_cast<float>(input0[i0]) - fConst52 * (fConst50 * fRec7[1] + fConst41 * fRec7[2] + fConst49 * fRec7[3] + fConst46 * fRec7[4]);
			fRec6[0] = fConst54 * (4.0f * fRec7[0] - 8.0f * fRec7[2] + 4.0f * fRec7[4]) - fConst44 * (fConst42 * fRec6[1] + fConst41 * fRec6[2] + fConst40 * fRec6[3] + fConst36 * fRec6[4]);
			fRec3[0] = fConst55 * (4.0f * fRec6[0] - 8.0f * fRec6[2] + 4.0f * fRec6[4]) * ftbl0mydspSIG0[std::max<int>(0, std::min<int>(static_cast<int>(65536.0f * fRec5[0]), 65535))] - fConst22 * (fConst21 * fRec3[2] + fConst17 * fRec3[1]);
			fRec2[0] = fConst22 * (fRec3[2] + fRec3[0] + 2.0f * fRec3[1]) - fConst20 * (fConst19 * fRec2[2] + fConst17 * fRec2[1]);
			fRec1[0] = fConst20 * (fRec2[2] + fRec2[0] + 2.0f * fRec2[1]) - fConst15 * (fConst13 * fRec1[2] + fConst11 * fRec1[1]);
			fRec0[0] = fConst56 * (fRec1[2] + (fRec1[0] - 2.0f * fRec1[1])) - fConst8 * (fConst6 * fRec0[2] + fTemp0);
			float fTemp2 = fTemp0 + fConst59 * fRec0[0] + fConst58 * fRec0[2];
			fVec2[0] = fTemp2;
			float fTemp3 = fConst60 * (fVec2[1] - fVec2[2]);
			float fTemp4 = fConst60 * fVec2[2];
			int iTemp5 = (fTemp4 <= 1.0f) & (fTemp4 >= -1.0f);
			float fTemp6 = 0.5f * mydsp_faustpower2_f(fTemp4);
			float fTemp7 = static_cast<float>((fTemp4 > 0.0f) - (fTemp4 < 0.0f));
			float fTemp8 = fConst60 * fVec2[1];
			int iTemp9 = (fTemp8 <= 1.0f) & (fTemp8 >= -1.0f);
			float fTemp10 = static_cast<float>((fTemp8 > 0.0f) - (fTemp8 < 0.0f));
			float fTemp11 = 0.5f * mydsp_faustpower2_f(fTemp8);
			float fTemp12 = ((iTemp9) ? fTemp11 : fConst60 * fVec2[1] * fTemp10 + -0.5f);
			float fTemp13 = ((iTemp9) ? 0.33333334f * mydsp_faustpower3_f(fTemp8) : fTemp10 * (fTemp11 + -0.16666667f));
			float fTemp14 = 1.6e+02f * fVec2[1];
			float fTemp15 = mydsp_faustpower2_f(fConst60 * (fTemp2 - fVec2[1]));
			float fTemp16 = fConst60 * fTemp2;
			int iTemp17 = (fTemp16 <= 1.0f) & (fTemp16 >= -1.0f);
			float fTemp18 = 0.5f * mydsp_faustpower2_f(fTemp16);
			float fTemp19 = static_cast<float>((fTemp16 > 0.0f) - (fTemp16 < 0.0f));
			output0[i0] = static_cast<FAUSTFLOAT>(((fTemp15 <= 0.001f) ? 0.5f * std::max<float>(-1.0f, std::min<float>(1.0f, fConst61 * (8e+01f * fTemp2 + fTemp14))) : (fConst60 * fTemp2 * (((iTemp17) ? fTemp18 : fConst60 * fTemp2 * fTemp19 + -0.5f) - fTemp12) + fTemp13 - ((iTemp17) ? 0.33333334f * mydsp_faustpower3_f(fTemp16) : fTemp19 * (fTemp18 + -0.16666667f))) / fTemp15) + ((mydsp_faustpower2_f(fTemp3) <= 0.001f) ? 0.5f * std::max<float>(-1.0f, std::min<float>(1.0f, fConst61 * (fTemp14 + 8e+01f * fVec2[2]))) : (fTemp13 + fConst60 * fVec2[2] * (((iTemp5) ? fTemp6 : fConst60 * fVec2[2] * fTemp7 + -0.5f) - fTemp12) - ((iTemp5) ? 0.33333334f * mydsp_faustpower3_f(fTemp4) : fTemp7 * (fTemp6 + -0.16666667f))) / mydsp_faustpower2_f(-fTemp3)));
			iVec0[1] = iVec0[0];
			fRec5[1] = fRec5[0];
